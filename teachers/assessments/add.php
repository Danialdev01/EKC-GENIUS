...
Keep each section concise and specific.";
        ...
        if (isset($_POST['save_and_next'])) {
            ...
            if ($nextStudent) {
                echo "<script>alert('Assessment saved!'); window.location.href = '?student_id=" . $nextStudent['student_id'] . "&month=$month&year=$year';</script>";
            } else {
                echo "<script>alert('Assessment saved! No more students to assess.'); window.location.href = '../../teachers/students/?id=$studentId';</script>";
            }
        } else {
            echo "<script>alert('Assessment saved successfully!'); window.location.href = '../../teachers/students/?id=$studentId';</script>";
        }
    }
}
?>