                    ...
                    <tbody class="divide-y divide-slate-100" id="tableBody">
                        ...
                        <tr class="student-row" data-name="<?= strtolower(htmlspecialchars($student['student_name'])) ?>">
                            ...
                            <td class="px-4 py-4">
                                ...
                                <a href="edit.php?student_id=<?= (int)$student['student_id'] ?>&month=<?= $currentMonth ?>&year=<?= $currentYear ?>" class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium bg-amber-100 text-amber-700 hover:bg-amber-200 transition-colors">
                                    Edit
                                </a>
                                <?php else: ?>
                                <a href="add.php?student_id=<?= (int)$student['student_id'] ?>&month=<?= $currentMonth ?>&year=<?= $currentYear ?>" class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium bg-emerald-100 text-emerald-700 hover:bg-emerald-200 transition-colors">
                                    Add
                                </a>
                                <?php endif; ?>
                            </td>
