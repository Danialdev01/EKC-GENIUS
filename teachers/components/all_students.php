...
// Separate query for category name
...
// Separate query for invoice status (same logic as info_student.php)
...
// Attach additional data to each student
...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
    ...
    <div class="px-6 py-4 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="<?= $location_index ?>/teachers/students/add.php" class="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-inter text-sm font-medium px-4 py-2.5 rounded-xl transition-colors shrink-0">
            ...
            <tbody class="divide-y divide-slate-100" id="studentTableBody">
                ...
                <tr class="student-row hover:bg-slate-50 transition-colors" data-name="<?= strtolower(htmlspecialchars($student['student_name'])) ?>">
                    ...
                    <td class="px-4 py-4">
                        ...
                        <a href="<?php echo $location_index?>/teachers/students/?id=<?= (int)$student['student_id'] ?>" class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium bg-amber-100 text-amber-700 hover:bg-amber-200 transition-colors">
                            Not Assessed Yet
                        </a>
                        <?php else: ?>
                    ...
                    <td class="px-4 py-4">
                        <div class="flex items-center gap-1">
                            <a href="<?php echo $location_index?>/teachers/students/?id=<?= (int)$student['student_id'] ?>" class="p-2 text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors" title="View">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                            </a>
                            <a href="<?= $location_index ?>/teachers/students/edit.php?id=<?= (int)$student['student_id'] ?>" class="p-2 text-slate-600 hover:bg-slate-100 rounded-lg transition-colors" title="Edit">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
