    <footer class="bg-[#1E293B] text-[#FAFBFC] mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                    ...
                    <p class="text-[#94A3B8] text-sm leading-relaxed">
                        Private kindergarten and childcare services in Perak, Malaysia.
                    </p>
                </div>
                
                <div class="lg:text-right">
                    <h4 class="text-sm font-semibold uppercase tracking-wider text-[#94A3B8] mb-4">Contact</h4>
            ...
            <div class="border-t border-[#334155] mt-8 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex items-center gap-6 text-sm text-[#94A3B8]">
